...
export function Features() {
  return (
    <section id='features' className='w-full scroll-mt-20 bg-[#f9f6ef] py-16 sm:py-24'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6'>

        {/* Section header */}
        <div className='mb-10 flex flex-col gap-3 sm:mb-16 md:flex-row md:items-end md:justify-between'>
          <div>
            <span className='mb-2 inline-block text-xs font-semibold uppercase tracking-widest text-[#e04e1f]'>
              Features
            </span>
            <h2
              className={`${fraunces.className} max-w-md text-3xl font-semibold leading-tight text-[#1a1916] sm:text-4xl md:text-5xl`}
            >
              Everything your
              <br />
              <em>team needs</em>
          ...
          <p className='max-w-sm text-sm leading-relaxed text-[#7a7770] md:max-w-xs md:text-right'>
...
function Card({ title, description, icon, number }: CardProps) {
  return (
    <div className='group flex flex-col gap-4 bg-[#f9f6ef] p-5 transition-colors duration-200 hover:bg-[#f5f1e8] sm:p-6 lg:p-8'>
